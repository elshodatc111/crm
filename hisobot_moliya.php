...
<?php include("./check/header.php"); ?>
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-4"><a href="./hisobot_moliya.php" class='btn btn-success w-100 py-1 my-1' style="border:0;border-radius:0;">MOLIYA</a></div>
    ...
    <section class="section dashboard">
      <div class="row">
        <div class="card info-card sales-card">
          <div class="card-body">
            <h5 class="card-title w-100 text-center pb-0 mb-1">Moliya</h5>
          </div>
        </div>
      </div>
    </section>
